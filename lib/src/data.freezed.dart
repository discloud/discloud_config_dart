...
mixin _$DiscloudConfigData {
  ...
  $DiscloudConfigDataCopyWith<DiscloudConfigData> get copyWith =>
      _$DiscloudConfigDataCopyWithImpl<DiscloudConfigData>(
          this as DiscloudConfigData, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is DiscloudConfigData &&
            const DeepCollectionEquality().equals(other.APT, APT) &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(APT),
      AUTORESTART,
      AVATAR,
      HOSTNAME,
      ID,
...
abstract mixin class $DiscloudConfigDataCopyWith<$Res> {
  factory $DiscloudConfigDataCopyWith(
          DiscloudConfigData value, $Res Function(DiscloudConfigData) _then) =
      _$DiscloudConfigDataCopyWithImpl;
  @useResult
  $Res call(
      {@TextToListConverter() List<String>? APT,
    ...
    return _then(_self.copyWith(
      APT: freezed == APT
          ...
          : APT // ignore: cast_nullable_to_non_nullable
              as List<String>?,
      AUTORESTART: freezed == AUTORESTART
          ? _self.AUTORESTART
...
extension DiscloudConfigDataPatterns on DiscloudConfigData {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_DiscloudConfigData value)? $default, {
...
/// @nodoc
@JsonSerializable()
class _DiscloudConfigData extends DiscloudConfigData {
  const _DiscloudConfigData(
      {@TextToListConverter() final List<String>? APT,
      @TextToBoolConverter() this.AUTORESTART,
      this.AVATAR,
      this.HOSTNAME,
      this.ID,
      this.MAIN,
      this.NAME,
      @TextToIntConverter() this.RAM,
      this.START,
      this.STORAGE,
      this.TYPE,
      this.VERSION,
      @TextToBoolConverter() this.VLAN})
      : _APT = APT,
        super._();
  factory _DiscloudConfigData.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$DiscloudConfigDataCopyWith<_DiscloudConfigData> get copyWith =>
      __$DiscloudConfigDataCopyWithImpl<_DiscloudConfigData>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$DiscloudConfigDataToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _DiscloudConfigData &&
            const DeepCollectionEquality().equals(other._APT, _APT) &&
            (identical(other.AUTORESTART, AUTORESTART) ||
                other.AUTORESTART == AUTORESTART) &&
            (identical(other.AVATAR, AVATAR) || other.AVATAR == AVATAR) &&
            (identical(other.HOSTNAME, HOSTNAME) ||
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(_APT),
      AUTORESTART,
      AVATAR,
      HOSTNAME,
      ID,
...
/// @nodoc
abstract mixin class _$DiscloudConfigDataCopyWith<$Res>
    implements $DiscloudConfigDataCopyWith<$Res> {
  factory _$DiscloudConfigDataCopyWith(
          _DiscloudConfigData value, $Res Function(_DiscloudConfigData) _then) =
      __$DiscloudConfigDataCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@TextToListConverter() List<String>? APT,
